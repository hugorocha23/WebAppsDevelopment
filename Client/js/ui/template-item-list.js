							...
							<HttpGetSwitch result={result}
								onJson={json => (
									<div>
										...
										<br /> <br />
										{
											json.links.find(link => link.rel === 'template-checklist') ?
												<div>
													<button onClick={() => this.state.onClickChecklist(json.links.find(link => link.rel === 'template-checklist').href)}>
														{json.links.find(link => link.rel === 'template-checklist').prompt}
													</button>
												</div>
												: ''
										}
